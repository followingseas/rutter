...
| [Rutter](https://github.com/followingseas/rutter) | 지침서 | 조직 공용 규약(conventions)과 조망 지도(charts). Pilot의 레퍼런스 rutter 인스턴스 |
...
GitHub Flow(main 단일 브랜치)를 전 저장소 공통으로 사용한다. 커밋 메시지는 Conventional Commits + 한글.
